...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contact' => ['type' => 'string', 'length' => 254, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'verified_at' => ['type' => 'timestamp', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
