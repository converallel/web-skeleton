...
class OauthAccessTokensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'oauth_access_tokens_ibfk_1' => ['type' => 'foreign', 'columns' => ['oauth_client_id'], 'references' => ['oauth_clients', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'oauth_access_tokens_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '9da97fdc-f8f1-4e3b-82a9-ffd668b19729',
                'user_id' => 1,
                'oauth_client_id' => 1,
                'name' => 'Lorem ipsum dolor sit amet',
                'revoked' => 1,
                'created_at' => 1552758366,
                'modified_at' => 1552758366,
                'expires_at' => 1552758366
            ],
        ];
        parent::init();
    }
