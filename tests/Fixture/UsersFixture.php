...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_2' => ['type' => 'foreign', 'columns' => ['profile_image_id'], 'references' => ['files', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'location_id' => 1,
                'profile_image_id' => 1,
                'created_at' => 1552770246,
                'modified_at' => 1552770246,
                'deleted_at' => 1552770246
            ],
        ];
        parent::init();
    }
