...
class DevicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'devices_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'user_id' => 1,
                'uuid' => 'd27e974e-f9cf-4724-8941-0bc145e78e46',
                'name' => 'Lorem ipsum dolor sit amet',
                'deleted_at' => 1552755596
            ],
        ];
        parent::init();
    }
