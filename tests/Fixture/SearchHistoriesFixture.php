...
class SearchHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'query' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'user_id' => ['type' => 'unique', 'columns' => ['user_id', 'type', 'query'], 'length' => []],
            'search_histories_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
